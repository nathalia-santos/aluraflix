...
class AutheticationUserTestCase(APITestCase):
    ...
    def test_autenticacao_user_com_credenciais_corretas(self):
        """Teste que verifica a autenticação um user com as credenciais corretas"""
    ...
    def test_autenticacao_de_user_com_password_incorreto(self):
        """Teste que verifica autenticação de um user com password incorreta"""
